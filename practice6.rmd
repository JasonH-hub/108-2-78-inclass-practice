...
listExample[c("學期")]   #這樣用不太好，[]最好用在兩個元素的時候 一個元素用[[]]較好
...
str(listExample[c("學期")])    #173跟174行意思一樣
str(listExample[c(T,T)]) # 要，要    要不要無法做出排序效果 只能按照順序列出
```
...
c(T,F,F,F,
  ...
  F,T,F,F,
  F,T) -> selectedMarkets
taipeiNightMarkets[selectedMarkets]   #187-191與183相同
